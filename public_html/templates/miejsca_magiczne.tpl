...
<div id="container">
	<div id="intro">
		<div id="pageHeader">
			...
			{else}
			<p class="p2"><span>Write to the author <a href=mailto:adventurewrites@gmail.com>adventurewrites@gmail.com</a></span></p>
			{/if}
	...
	<div id="supportingText">
		...
		{/if}
			...
			<p class="p1"><span>{$miejsca1}</span></p>
			<p class="p2"><span>{$miejsca2}</span></p>
		</div>
