<?php /* Smarty version 2.6.18, created on 2010-06-22 15:02:05
         compiled from prace_wlasne.tpl */ ?>
...
<div id="container">
	<div id="intro">
		...
		<div id="preamble">
			<a href=index.php?english=0><img src="img/poland.gif" alt="PL" align=right border=0></a>
			<a href=index.php?english=1><img src="img/great-britain.gif" alt="GB" align=right border=0></a>
	...
	<div id="supportingText">
		<div id="prace_wlasne">
			<h3><span>Prace w³asne</span></h3>
			<p class="p1"><span><?php echo $this->_tpl_vars['prace_wlasne1']; ?>
</span></p>
			<p class="p2"><span><?php echo $this->_tpl_vars['prace_wlasne2']; ?>
</span></p>
		</div>
