...
//    define('samochody2','samochody2');
	...
	$podroze1 = 'Tak jak w Szwecji rower był jedynym słusznym środkiem transportu, tak tutaj Vespy są bezkonkurencyjne. W godzinach szczytu te malutkie motorki przeciskają się między samochodami jak mrówki niosące na plecach swój pakunek i dla których nie ma żadnych przeszkód w dotarciu do celu. Pasą się tu na chodnikach stadami, a potem wyciskając siódme poty ze swoich malutkich silniczków wspinają się po stromych ulicach wioząc nierzadko na grzbiecie po dwie osoby plus bagaż.<br>
                 <a href=stuttgart2016.php>Stuttgart wiosenny i gorący</a> - ostatnia aktualizacja 05.01.2017';
                 $podroze2 = '<br>';

    $podroze2.=  '
                 <b><a href="http://adventure.host22.com/adventure_polska.xml"><img src=img/rss_icon.gif width=12 border=0></a> Polska</b><br>
                 ...
                 <br><b><a href="http://adventure.host22.com/adventure_sweden.xml"><img src=img/rss_icon.gif width=12 border=0></a> Szwecja</b><br>
                 ...
                 <br><b><a href="http://adventure.host22.com/adventure_inne.xml"><img src=img/rss_icon.gif width=12 border=0></a> Inne</b><br>
