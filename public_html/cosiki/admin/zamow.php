...
if (!isset($time1))
 ...
 { mysql_select_db($base);
   ...
   { if ($row["zam_zatw"]=='T')
     ...
     $table1->AddRow("<form name=\"form$numrec\" method=get action=\"zamow.php\">
 ...
 if ($numrec>0)
   { $menu='menu/menu_zamow.txt';
   }
 else
   { $menu='menu/menu_zamow_pusto.txt';
   }
 $tytul="SSI SKLEP: zamówienia niezrealizowane";
 include 'menu.php';
 $table1->Process();
 $table1->Display();
 }
